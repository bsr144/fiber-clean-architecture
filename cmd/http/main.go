...
func bootstrapingTheApp(bootstrap config.Bootstrap) {
	...
	patientUsecase := patients.NewPatientUsecase(patientMongoRepository, patientFhirClient)
	...
	routers.SetupRoutes(bootstrap.App, bootstrap.DriverConfig.App, patientController, authController)
}
